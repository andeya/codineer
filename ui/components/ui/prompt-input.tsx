...
export type PromptInputTextareaProps = {
  ...
  /** Inline prefix rendered before the textarea in the same flex row */
...
function PromptInputTextarea({
  ...
  if (!hasPrefix) return textarea;

  return (
    <div className="flex flex-wrap items-center gap-x-1 gap-y-0.5 px-3 py-1">
      {inlinePrefix}
      <div className="min-w-[80px] flex-1">{textarea}</div>
    </div>
  );
}
