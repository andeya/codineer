const en = {
  ...
  chat: {
    ...
    reasoningLive: "Model reasoning (streaming)",
    reasoningDurationTpl: "Thought for {seconds}s",
    reasoningLiveForTpl: "Thinking for {seconds}s",
  },
  ...
  settings: {
    ...
    streamTimeoutHint:
      "Safety timeout for AI/agent streaming responses. If no data arrives within this period the request is cancelled.",
    ...
    providerIdHint: "Unique identifier used in model names (e.g. openai/gpt-4o)",
    providerIdPlaceholder: "my-openai",
    providerPreset: "Preset",
    providerDisplayName: "Display Name",
    providerDisplayNamePlaceholder: "My OpenAI",
    providerDisplayNameHint:
      "Shown in the list. Used to generate the Provider ID; change the ID under Advanced if needed.",
    ...
    fetchModelsFromServer: "Fetch model list from server",
    fetchModelsEmpty: "No models returned by the server.",
    testConnection: "Test Connection",
    testSuccess: "Connected",
    testSuccessWithCount: "Connected — {0} models available",
    noProvidersHint: "Choose a provider to get started",
    modelsCount: "models",
    addModel: "Add model name...",
    advancedOptions: "Advanced",
    statusAvailableKey: "Available — API key configured",
    statusAvailableLocal: "Available — local service",
    statusUnavailable: "Unavailable — no API key configured",
    ...
    webViewPagesDesc:
      "Hidden browser pages used by WebAI providers. Pages are created on first use and auto-closed after idle timeout.",
    webAiIdleTimeout: "Idle Timeout (s)",
    webAiIdleTimeoutHint:
      "How long an unused WebView page stays alive before being automatically closed.",
    webAiPageLoadTimeout: "Page Load Timeout (s)",
    webAiPageLoadTimeoutHint: "Max time to wait for a WebView page to become ready after creation.",
    closeAll: "Close All",
    closePage: "Close",
    pageActive: "Active",
    pageInactive: "Inactive",
